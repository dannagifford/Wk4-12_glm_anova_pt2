...
<iframe width="560" height="315" src="https://youtube.com/embed/zGifY-McqsQ" frameborder="0" allowfullscreen></iframe>
...
## Setting up our Constrasts

```{r}
contrasts(my_data$Condition)
```

We want our Water group to be the reference level (thus corresponding to the intercept of our linear model), and cdummy oded as (0, 0) but it's not currently coded as such. Let's fix that.
